                ...
                <div class="col-12 col-md-6"></div>
                    <form action="index.php" method="POST">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="radio" class="form-check-input" id="colecao_sim" name="colecao" value="SIM" required>
                                <label class="form-check-label" for="colecao_sim">Sim</label>
                            </div>
                            <div class="col-md-10">
                                <input type="radio" class="form-check-input" id="colecao_nao" name="colecao" value="NÃO" checked required>
                                <label class="form-check-label" for="colecao_nao">Não</label>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input class="form-control" name="upload" type="url" id="capa">
                        </div>
